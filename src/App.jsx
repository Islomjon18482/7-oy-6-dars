...
function App() {
  ...
  useEffect(()=>{
    if(localStorage.getItem("time")){
      setMinutes(JSON.parse(localStorage.getItem("time")))
    }else{
    ...
    <div className="container">
      <div  className="pomodoro">
        ...
        <main>
          <div className="time">
            <div className="btns">
              <button onClick={() => heandleType("pomodoro")}>Pomodoro</button>
              <button onClick={() => heandleType("short")}>Short Breake</button>
              <button onClick={() => heandleType("long")}>Long Breake</button>
            </div>
            <h2 className="timer">
            ...
            <div className="btns">
              ...
              {isActive ?  <button className="start" onClick={handleReset}>Reset</button> : ''}
            </div>
          </div>
        </main>
      </div>
